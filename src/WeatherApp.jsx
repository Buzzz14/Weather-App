...
function WeatherApp() {
    ...
    return (
        <div className="max-w-xl min-h-fit my-12 mx-auto p-12 bg-l-gray shadow-lg rounded-xl">
            ...
            {notFound ? (
                <div className="flex-col capitalize items-center">
                    <h1 className="m-6 mt-20 font-bold text-3xl text-center">{weatherData.message}!!!</h1>
                ...
                <div className="text-center text-lg p-7">
                    ...
                    <div className="mb-5">
                        ...
                        <p className="text-2xl text-gray-600 mt-2.5 capitalize">{weatherData.weather[0].description}</p>
                    </div>
                    <div className="flex justify-between mt-20">
                        ...
                        <div className="flex items-center text-lg ">
                            ...
                            <div className="flex flex-col items-center">
                                <span className="text-xl font-semibold">{weatherData.wind.speed}Km/H</span>
